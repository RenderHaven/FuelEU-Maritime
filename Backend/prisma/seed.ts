...
async function main() {
  ...
  // 🧹 Delete in correct order (avoid FK issues)
  ...
  console.log('Seeding initial FuelEU routes...');
  ...
  const routesData = [
    ...
    { routeId: 'R001', vesselType: 'Container', fuelType: 'HFO', year: 2023, ghgIntensity: 89.2, fuelConsumption: 4900, distance: 11800, totalEmissions: 4300, isBaseline: false },
  ];
